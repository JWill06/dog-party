...
`, "",{"version":3,"sources":["webpack://./src/css/index.css"],"names":[],"mappings":"AAEA;EACE,gEAA0D;EAC1D,aAAa;EACb,YAAY;EACZ,SAAS;EACT,UAAU;EACV,kCAAkC;AACpC;;;AAGA;EACE,+CAA+C;EAC/C,aAAa;EACb,YAAY;EACZ,8BAA8B;EAC9B,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,iBAAiB;AACnB;;AAEA;;;;EAIE,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,uBAAuB;EACvB,0CAA0C;EAC1C,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,qBAAqB;EACrB,YAAY;EACZ,kBAAkB;AACpB;;;AAGA;EACE,8BAA8B;EAC9B,gBAAgB;EAChB,mBAAmB;AACrB;;AAEA;EACE,oBAAoB;AACtB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,WAAW;EACX,iBAAiB;AACnB;;AAEA;EACE,qBAAqB;EACrB,aAAa;AACf;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,YAAY;EACZ,qBAAqB;AACvB;;;AAGA;EACE,aAAa;EACb,sBAAsB;EACtB,6BAA6B;EAC7B,mBAAmB;EACnB,kBAAkB;EAClB,aAAa;AACf;;AAEA;EACE,aAAa;EACb,aAAa;EACb,YAAY;EACZ,mBAAmB;EACnB,kBAAkB;EAClB,uBAAuB;EACvB,gBAAgB;EAChB,8BAA8B;AAChC;;AAEA;EACE,kBAAkB;EAClB,0CAA0C;AAC5C;;AAEA;;;;EAIE,kBAAkB;EAClB,0CAA0C;EAC1C,YAAY,EAAE,iBAAiB;AACjC;;AAEA;EACE,0CAA0C;EAC1C,+BAA+B;EAC/B,eAAe;EACf,kCAAkC;AACpC;;AAEA;EACE,YAAY;EACZ,YAAY;AACd","sourcesContent":["@import 'variables.css';\n\nbody {\n  background: url('../../dist/images/park.jpg') center/cover;\n  height: 100vh;\n  width: 100vw;\n  margin: 0;\n  padding: 0;\n  font-family: \"Raleway\", sans-serif;\n}\n\n\n.header-section {\n  background-color: var(--secondary-accent-color);\n  display: flex;\n  height: 60px;\n  justify-content: space-between;\n  font-size: 20px;\n}\n\n.header-section ul :nth-child(1) {\n  margin-right: 10px;\n  margin-left: 10px;\n}\n\n.facebook,\n.twitter,\n.instagram,\n.linkedin {\n  height: 40px;\n  margin-right: 40px; \n}\n\n.main-footer {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  background-color: var(--main-accent-color); \n  color: white; \n  text-align: center;\n}\n\nfooter a {\n  list-style-type: none;\n  color: white;\n  margin-right: 55px;\n}\n\n\n.main-footer img{\n  justify-content: space-between;\n  margin-top: 10px;\n  margin-bottom: 10px; \n}\n\n.main-footer li a {\n  justify-self: center;\n}\n\n.main-footer ul li {\n  list-style: none;\n}\n\n.dog-icon {\n  width: 50px;\n  margin-left: 10px;\n}\n\nnav ul {\n  list-style-type: none;\n  display: flex;\n}\n\nnav ul li {\n  margin-right: 5px;\n}\n\nnav ul li a {\n  color: white;\n  text-decoration: none;\n}\n\n\n.first-div {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-evenly;\n  align-items: center;\n  text-align: center; \n  height: 500px; \n}\n\n.content-wrapper {\n  display: flex;\n  height: 450px;\n  width: 100vw;\n  align-items: center;\n  text-align: center;\n  background-color: white;\n  margin-bottom: 0;\n  justify-content: space-between;\n}\n\n.dog-1-image {\n  border-radius: 50%;\n  border: 6px solid var(--main-accent-color); \n}\n\n.dog-2-image,\n.dog-3-image,\n.dog-4-image\n {\n  border-radius: 50%;\n  border: 6px solid var(--main-accent-color); \n  width: 150px; object-fit: cover;\n}\n\nbutton {\n  border: 4px solid var(--main-accent-color);\n  color: var(--main-accent-color);\n  cursor: pointer;\n  font-family: \"Raleway\", sans-serif;\n}\n\n.what-are-dogs {\n  height: 40px;\n  width: 130px;\n}\n\n"],"sourceRoot":""}]);
// Exports
